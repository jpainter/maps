...
# browse to orotl.shp
orotl.shp <- readShapeLines('C:/Users/bzp3/Desktop/R/Maps/orotl', proj4string=CRS("+proj=longlat"))

# Oregon climate station data (points)
# browse to orstations.shp
orstations.shp <- readShapePoints('C:/Users/bzp3/Desktop/R/Maps/orstations', proj4string=CRS("+proj=longlat"))

# Oregon county census data (polygons)
# browse to orcounty.shp
orcounty.shp <- readShapePoly('C:/Users/bzp3/Desktop/R/Maps/orcounty', proj4string=CRS("+proj=longlat"))
